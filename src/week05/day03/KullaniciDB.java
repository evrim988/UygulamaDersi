...
import week05.day03.Kullanici;
import week05.day03.KullaniciOzelListe;
...
/*default*//*
 class KullaniciDB {
    ...
    static Kullanici save(Kullanici kullanici){
        return KullaniciOzelListe.ad(kullanici);
    }
    ...
    static Kullanici[] findAll(){
        [] kullaniciDizisi = kullaniciOzelListe.getKullaniciDizisi();
